...
int row060=8;
int col060=4;
JPanel seatplan060 = new JPanel(new GridLayout(row060, col060,
10, 10));
...
seatbuttons[i][newj].addActionListener(new
ActionListener() {
@Override
...
JOptionPane.showMessageDialog(frame060,
